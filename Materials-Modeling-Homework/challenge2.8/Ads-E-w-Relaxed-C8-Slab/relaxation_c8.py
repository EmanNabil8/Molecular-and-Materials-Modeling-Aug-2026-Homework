...
traj = Trajectory('relaxation_c8.traj', 'w', atoms)

# Pass the Trajectory object to BFGS 
opt = BFGS(atoms, trajectory=traj, logfile='relaxation_c8.log')
...
try:
    ...
    write('c8_relaxed_structure.vasp', atoms, format='vasp', direct=False)
    print("\nFinal relaxed structure saved to: c8_relaxed_structure.vasp", flush=True)
