...
class UO2I2Optimizer:
    ...
    def find_model(self):
        ...
        # Check for the specific model path provided by the user
        specific_path = Path('/home/compchemisteman/.cache/mace/20231203mace128L1_epoch199model')
        if specific_path.exists():
            print(f"{Colors.GREEN}✓ Found model: {specific_path}{Colors.NC}")
            return str(specific_path)
        
        # Other common paths (fallback)
        common_paths = [
        ...
        # Try to find any .model file in the mace cache directory
